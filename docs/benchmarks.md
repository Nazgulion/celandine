...
supplement](benchmarks/large-input-memory.md) for later measurements and reproduction commands.
...
The original run reported latency and throughput for 16, 64, and 256 B; 1, 4, 16, and
